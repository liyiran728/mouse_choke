...
function centerMousetrainingRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of centerMousetrainingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function startpositiontrainingRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of startpositiontrainingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trialtrainingRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of trialtrainingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function feedbacktrainingRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of feedbacktrainingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function EndTrainingRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of EndTrainingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_colorpointsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_colorpointsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function break_warningRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of break_warningComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function centerMouseRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of centerMouseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function startpositionRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of startpositionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function blockbreakRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of blockbreakComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function outcomesRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of outcomesComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
