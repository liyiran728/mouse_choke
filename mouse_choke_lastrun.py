...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/yiranli/Downloads/UMich/Research/CoCoA Lab/Mouse_choke task/mouse_choke/mouse_choke_lastrun.py',
...
slider = visual.Slider(win=win, name='slider',
    ...
    labels=['Mouse','Trackpad'], ticks=(1,2), granularity=0.0,
    style='rating', styleTweaks=('triangleMarker',), opacity=None,
    color='White', fillColor='Dodgerblue', borderColor='White', colorSpace='rgb',
...
# keep track of which components have finished
questionComponents = [question_text, slider, question_key_resp]
...
while continueRoutine:
    ...
    if question_key_resp.status == STARTED and not waitOnFlip:
        theseKeys = question_key_resp.getKeys(keyList=['space'], waitRelease=False)
...
training = data.TrialHandler(nReps=0, method='sequential', 
...
# completed 0 repeats of 'training'
...
for thisBlock in blocks:
    ...
    # set up handler to look after randomisation of conditions etc
    experiment = data.TrialHandler(nReps=0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
    ...
    # completed 0 repeats of 'experiment'
